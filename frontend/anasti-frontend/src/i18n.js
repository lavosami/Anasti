...
const messages = {
  en: {
    ...
    results: {
      ...
      numericSelect: 'Choose a numeric field',
      mean: 'Mean',
    ...
    charts: {
      ...
      title: 'Charts',
      rows: '{count} rows',
      empty: 'Import a dataset to build charts.',
      ...
      pieSum: 'Sum values',
      pieValue: 'Value field',
      noNumeric: 'Add data to render a chart.',
  ...
  ru: {
    ...
    results: {
      ...
      numericSelect: 'Выберите числовое поле',
    ...
    charts: {
      ...
      title: 'Графики',
      rows: '{count} строк',
      empty: 'Импортируйте датасет, чтобы построить графики.',
      scatterTitle: 'Точечная диаграмма',
      ...
      pieSum: 'Сумма значений',
      pieValue: 'Поле значений',
      noNumeric: 'Добавьте данные для построения.',
